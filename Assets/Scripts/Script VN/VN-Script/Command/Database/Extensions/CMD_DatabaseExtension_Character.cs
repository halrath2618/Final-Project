...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Character : CMD_Database_Extension
    {
        ...
        public static void CreateCharacter(string[] data)
        {
            ...
            parameters.TryGetValue(PARAM_ENABLE, out enable, false);
        ...
        private static IEnumerator MoveCharacter(string[] data)
        {
            ...
            parameters.TryGetValue(PARAM_SPEED, out speed, 1);
            parameters.TryGetValue(PARAM_SMOOTH, out smooth, false);
            parameters.TryGetValue(PARAM_IMMEDIATE, out immediate, false);
        ...
        public static IEnumerator ShowAll(string[] data)
        {
            ...
            //Convert the data array to para
